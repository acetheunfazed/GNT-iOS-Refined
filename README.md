# GNT Glass New Tab — iOS-Style Dashboard

A privacy-first Chrome extension that transforms your new tab with a beautiful glass morphism dashboard inspired by iOS and macOS design.

![Glass New Tab Dashboard](assets/icons/icon-128.png)
...
- **Responsive Design** — Perfect on desktop, laptop, and large screens
- **Smart Caching** — Rounded location caching for privacy-preserving weather

## 🚀 Installation

### From Chrome Web Store
Visit the Chrome Web Store to install the official version:
[GNT Glass New Tab](https://chrome.google.com/webstore)

### From GitHub (Development)

1. **Clone or download this repository**
   ```bash
   git clone https://github.com/developer-animesh7/GNT-Glass-New-Tab--iOS-Type-Dashboard.git
   ```
...
See [privacy.html](privacy.html) for detailed privacy policy.
...
├── newtab.html/css/js     # New tab page UI
...
├── early-theme.js         # Theme initialization
└── settingsStore.js       # Storage management
```
...
Compress-Archive -Path * -DestinationPath "GNT-Glass-New-Tab-3.0.0.zip"
```
...
**Animesh Patra** — [@developer-animesh7](https://github.com/developer-animesh7)
